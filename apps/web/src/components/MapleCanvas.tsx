...
export const MapleCanvas = ({
  ...
  >
    ...
    <path
      ...
      fill="#8B3A00"
      opacity="0.09"
      transform="translate(380,130) scale(3.8) rotate(12)"
    />
    <path
      ...
      fill="#8B3A00"
      opacity="0.09"
      transform="translate(680,820) scale(3.2) rotate(-8)"
    />
    <path
      ...
      fill="#7A2800"
      opacity="0.14"
      transform="translate(55,530) scale(2.4) rotate(20)"
    />
    <path
      d="M0,-14 C1,-10 6,-9 4,-4 C8,-6 11,-4 9,0 C12,-1 14,2 11,3 C14,5 12,9 8,8 C9,11 6,13 3,10 C3,13 0,14 0,11 C0,14 -3,13 -3,10 C-6,13 -9,11 -8,8 C-12,9 -14,5 -11,3 C-14,2 -12,-1 -9,0 C-11,-4 -8,-6 -4,-4 C-6,-9 -1,-10 0,-14 Z M0,-14 L0,16"
      fill="#7A2800"
      opacity="0.14"
      transform="translate(720,380) scale(2) rotate(-25)"
    />
